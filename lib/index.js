...
ShortcutsModal.prototype.toggle = function () {
  if (document.querySelectorAll('.shortcuts_modal').length) {
    this.hide();
  } else {
    this.show();    
  }
...
ShortcutsModal.prototype.hide = function (fn) {
  this.modal.hide(fn);
  return this;
}
...
ShortcutsModal.prototype.bind = function (triggerKey) {
  ...
  this.bindKey(triggerKey, bind(this, this.toggle));
  return this;
}
